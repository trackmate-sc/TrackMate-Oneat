...
import static fiji.plugin.trackmate.oneat.DivisionSpotCollection.VISIBILITY;
...
public class DivisionSpot extends AbstractEuclideanSpace implements RealLocalizable, Comparable< DivisionSpot >
{
	 ...
	 *            the spot name.
	 */
	public DivisionSpot( final double x, final double y, final double z, final double radius, final double quality, final String name )
	{
		super( 3 );
	 ...
	 *            the spot quality.
	 */
	public DivisionSpot( final double x, final double y, final double z, final double radius, final double quality )
	{
	 ...
	 *            the spot name.
	 */
	public DivisionSpot( final RealLocalizable location, final double radius, final double quality, final String name )
	{
	 ...
	 *            the spot quality.
	 */
	public DivisionSpot( final RealLocalizable location, final double radius, final double quality )
	{
	 ...
	 */
	public DivisionSpot( final DivisionSpot spot )
	{
	 ...
	 *            the spot ID to set
	 */
	public DivisionSpot( final int ID )
	{
		super( 3 );
		this.ID = ID;
	...
	@Override
	public int compareTo( final DivisionSpot o )
	{
		return ID - o.ID;
	}
	...
	public boolean equals( final Object other )
	{
		...
		if ( other == this )
			return true;
		if ( !( other instanceof DivisionSpot ) )
			return false;
		final DivisionSpot os = ( DivisionSpot ) other;
		return os.ID == this.ID;
	}

	public void setRoi( final DivisionSpotRoi roi )
	{
		this.roi = roi;
	}

	public DivisionSpotRoi getRoi()
	{
		return roi;
	}

	/**
	 * @return the name for this DivisionSpot.
	 */
	...
	/**
	 * Set the name of this DivisionSpot.
	 * 
	 * @param name
	 *            the name to use.
	 */
	...
	public String echo()
	{
		...
		// Name
		if ( null == name )
			s.append( "DivisionSpot: <no name>\n" );
		else
			s.append( "DivisionSpot: " + name + "\n" );
	 ...
	 */
	public double diffTo( final DivisionSpot s, final String feature )
	{
	 ...
	 */
	public double normalizeDiffTo( final DivisionSpot s, final String feature )
	{
	...
	static
	{
		...
		FEATURES.add( FRAME );
		FEATURES.add( RADIUS );
		FEATURES.add( DivisionSpotCollection.VISIBILITY );
	 ...
	 */
	public final static Comparator< DivisionSpot > featureComparator( final String feature )
	{
		final Comparator< DivisionSpot > comparator = new Comparator< DivisionSpot >()
		{
			@Override
			public int compare( final DivisionSpot o1, final DivisionSpot o2 )
			{
	...
	public final static Comparator< DivisionSpot > timeComparator = featureComparator( POSITION_T );

	/** A comparator used to sort spots by ascending frame. */
	public final static Comparator< DivisionSpot > frameComparator = featureComparator( FRAME );

	/**
	 * A comparator used to sort spots by name. The comparison uses numerical
	 * natural sorting, So that "DivisionSpot_4" comes before "DivisionSpot_122".
	 */
	public final static Comparator< DivisionSpot > nameComparator = new Comparator< DivisionSpot >()
	{
